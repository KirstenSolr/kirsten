...
public class AjaxURLNormalizer implements URLNormalizer {
  ...
  public String normalize(String urlString, String scope) throws MalformedURLException {
    // Transform #! URL's to their _escaped_fragment_ counterpart
    if (urlString.contains(AJAX_URL_PART)) {
      return normHash(urlString);
    }

    // Transform _escaped_fragment_ URL's to their #! counterpart
    if (urlString.contains(ESCAPED_URL_PART)) {
      return normEscFragment(urlString);
    }
   ...
   * @return String
   */
  protected String normHash(String urlString) throws MalformedURLException {
   ...
   * @return String
   */
  protected String normEscFragment(String urlString) throws MalformedURLException {
