...
package org.apache.nutch.net.urlnormalizer.aregex;
 ...
 *
 * This module is a clone of the ordinary regex normalizer but intended to
 * run as the first normalizer, hence it can avoid the basic normalizer to
 * remove anchor links in certain cases. Anchor links will be rewritten in this
 * module and can be returned in the ordinary regex plugin.
 * 
 * <p>This class uses the <tt>urlnormalizer.aregex.file</tt> property.
 ...
 */
public class ARegexURLNormalizer extends Configured implements URLNormalizer {

  private static final Logger LOG = LoggerFactory.getLogger(ARegexURLNormalizer.class);
   ...
   */
  public ARegexURLNormalizer() {
    super(null);
  }

  public ARegexURLNormalizer(Configuration conf) {
    super(conf);
  }
   ...
   */
  public ARegexURLNormalizer(Configuration conf, String filename)
  ...
  public void setConf(Configuration conf) {
    ...
    String filename = getConf().get("urlnormalizer.aregex.file");
    String stringRules = getConf().get("urlnormalizer.aregex.rules");
    Reader reader = null;
    if (stringRules != null) {
   ...
   */
  public String aRegexNormalize(String urlString, String scope) {
    HashMap<String, List<Rule>> scopedRules = getScopedRules();
    List<Rule> curRules = scopedRules.get(scope);

    if (curRules == null) {
      // try to populate
      String configFile = getConf().get("urlnormalizer.aregex.file." + scope);
      if (configFile != null) {
  ...
  public String normalize(String urlString, String scope)
    ...
    return aRegexNormalize(urlString, scope);
  }
  ...
  public static void main(String args[]) throws PatternSyntaxException,
          IOException {
    ARegexURLNormalizer normalizer = new ARegexURLNormalizer();
